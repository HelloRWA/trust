import { acala, hardhat, mantleTestnet, polygonAmoy, celo, goerli, polygon, avalancheFuji, optimismGoerli, moonbaseAlpha, moonbeam, bscTestnet, celoAlfajores } from 'viem/chains'
...
const allChains = {
  ...
  acala,
  celo,
  hardhat, mantleTestnet, goerli, polygon, avalancheFuji, optimismGoerli, polygonAmoy, moonbaseAlpha, moonbeam, bevmCanary, bevmCanaryTestnet, bevmTestnet
}
